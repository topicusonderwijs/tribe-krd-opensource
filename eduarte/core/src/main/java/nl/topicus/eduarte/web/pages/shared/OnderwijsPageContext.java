...
public class OnderwijsPageContext implements PageContext
{
	...
	public OnderwijsPageContext(String name, MenuItemKey menuItem)
	{
		this.name = name;
	...
	{
		return CoreMainMenuItem.Onderwijs;
	}

	@Override
	public AbstractMenuBar getMenu(String id)
	{
		return new OnderwijsCollectiefMenu(id, menuItem);
	}

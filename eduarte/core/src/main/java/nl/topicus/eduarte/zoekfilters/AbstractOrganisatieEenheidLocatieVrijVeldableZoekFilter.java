...
public class AbstractOrganisatieEenheidLocatieVrijVeldableZoekFilter<V extends VrijVeldEntiteit, T>
		extends AbstractOrganisatieEenheidLocatieZoekFilter<T> implements VrijVeldable<V>
{
	...
	public AbstractOrganisatieEenheidLocatieVrijVeldableZoekFilter(Class<V> vrijVeldEntiteitClass)
	{

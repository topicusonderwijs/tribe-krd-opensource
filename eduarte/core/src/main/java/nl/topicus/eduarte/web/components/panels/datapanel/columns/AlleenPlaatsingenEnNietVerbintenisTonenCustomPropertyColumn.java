...
public class AlleenPlaatsingenEnNietVerbintenisTonenCustomPropertyColumn<T extends IdObject>
		extends CustomPropertyColumn<T>
{
	private static final long serialVersionUID = 1L;

	public AlleenPlaatsingenEnNietVerbintenisTonenCustomPropertyColumn(String id, String header,

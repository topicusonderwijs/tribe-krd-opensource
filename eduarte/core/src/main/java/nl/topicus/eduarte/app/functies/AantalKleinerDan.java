 ...
 * @author loite
 */
public class AantalKleinerDan implements Function
{
	public static final AantalKleinerDan INSTANCE = new AantalKleinerDan();

	/**
	 * Private constructor, er is maar 1 instance.
	 */
	private AantalKleinerDan()
	{
	}
	...
	public FunctionResult execute(Evaluator evaluator, String arguments) throws FunctionException
	{
		...
		if (args.length < 2)
		{
			throw new FunctionException(
				"Verkeerd aantal parameters meegegeven voor functie aantalLagerDan (minimaal 2 waarden nodig).");
		}

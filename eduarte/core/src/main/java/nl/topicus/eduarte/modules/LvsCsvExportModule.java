...
public class LvsCsvExportModule extends AbstractCobraModule
{
	private final EncryptionProvider encryptionProvider = new CobraEncryptonProvider();

	public LvsCsvExportModule()
	{
		super(EduArteModuleKey.LVS_CSV_EXPORT);
	}
	...
	protected void registerMenuExtenders()
	{
		...
		addMenuExtender(DeelnemerCollectiefMenu.class, new LvsCsvExportMenuExtender());
	}
}

...
@Display(parent = "Deelnemer", label = "Vooropleidingen", module = {
	EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS, EduArteModuleKey.BASISFUNCTIONALITEIT})
@Description("Vooropleidingen van een deelnemer bekijken")
public class DeelnemerVooropleidingen extends AbstractEduArtePrincipalSource
{

package nl.topicus.eduarte.core.principals.deelnemer.groep;
...
@Display(parent = "Deelnemer", label = "Groepen", module = EduArteModuleKey.BASISFUNCTIONALITEIT)
@Description("Groepen van een deelnemer bekijken")
public class DeelnemerGroepen extends AbstractEduArtePrincipalSource
{

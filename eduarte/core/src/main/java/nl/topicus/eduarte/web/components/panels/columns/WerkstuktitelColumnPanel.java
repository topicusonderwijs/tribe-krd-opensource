 ...
 * @author vandekamp
 */
public class WerkstuktitelColumnPanel extends Panel
{
	...
	public WerkstuktitelColumnPanel(String id, IModel<Productregel> productregelModel,
			IModel<Verbintenis> verbintenisModel)
	{
		...
		if (context != null)
			add(new Label("label", context.getOnderwijsproductAfname().getWerkstuktitel()));
		else
		{
			add(new Label("label", ""));
		}

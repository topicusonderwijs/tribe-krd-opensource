...
@Display(parent = "Groep", label = "Documenten", module = EduArteModuleKey.BASISFUNCTIONALITEIT)
@Description("Documenten van groepen inzien")
public class GroepDocumenten extends AbstractEduArtePrincipalSource
{

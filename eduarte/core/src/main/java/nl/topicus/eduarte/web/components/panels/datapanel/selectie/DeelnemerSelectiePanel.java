...
public class DeelnemerSelectiePanel<R extends IdObject> extends
		EduArteDatabaseSelectiePanel<R, Verbintenis, VerbintenisZoekFilter>
{
	private static final long serialVersionUID = 1L;

	public DeelnemerSelectiePanel(String id, VerbintenisZoekFilter filter,
	...
	{
		return new DeelnemerZoekFilterPanel(id, filter, customDataPanel);
	}

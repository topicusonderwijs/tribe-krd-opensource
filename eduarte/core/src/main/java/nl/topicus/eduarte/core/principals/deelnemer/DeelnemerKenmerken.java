...
@Display(parent = "Deelnemer", label = "Kenmerken", module = {
	EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS, EduArteModuleKey.BASISFUNCTIONALITEIT})
@Description("Kenmerken van een deelnemer bekijken")
public class DeelnemerKenmerken extends AbstractEduArtePrincipalSource
{

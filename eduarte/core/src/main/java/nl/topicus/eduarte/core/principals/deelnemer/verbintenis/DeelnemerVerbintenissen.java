...
@Display(parent = "Deelnemer", label = "Verbintenissen", module = {
	EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS, EduArteModuleKey.BASISFUNCTIONALITEIT})
@Description("Verbintenissen van een deelnemer bekijken")
public class DeelnemerVerbintenissen extends AbstractEduArtePrincipalSource
{

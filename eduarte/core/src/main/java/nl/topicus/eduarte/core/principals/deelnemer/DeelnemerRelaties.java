...
@Display(parent = "Deelnemer", label = "Relaties", module = {
	EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS, EduArteModuleKey.BASISFUNCTIONALITEIT})
@Description("Relaties van een deelnemer bekijken")
public class DeelnemerRelaties extends AbstractEduArtePrincipalSource
{

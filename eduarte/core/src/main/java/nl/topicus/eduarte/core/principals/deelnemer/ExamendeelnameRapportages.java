...
@Display(parent = "Examendeelname", label = "Rapportages", module = EduArteModuleKey.BASISFUNCTIONALITEIT)
@Description("Rapportages over deelnemer examendeelnames maken")
public class ExamendeelnameRapportages extends AbstractEduArtePrincipalSource
{

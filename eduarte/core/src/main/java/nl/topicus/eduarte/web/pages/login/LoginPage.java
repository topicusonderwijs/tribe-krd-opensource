...
public class LoginPage extends BasePage implements LoginEventProcessor
{
	...
	public LoginPage(PageParameters parameters)
	{
		...
		if (organisatie != null && organisatie.getRechtenSoort() == RechtenSoort.BEHEER)
		{
			info("Aanmelden voor " + organisatie.getNaam());
			newLandelijkBeheerSignInPanel(panelId, organisatie);
		}
		...
		{
			info("Selecteer een organisatie");
			add(new OrganisatieSelectiePanel(panelId));
		}
	...
	private void newLandelijkBeheerSignInPanel(String panelId, Organisatie organisatie)
	{
		add(new LandelijkBeheerSignInPanel(panelId, organisatie, this));
	}

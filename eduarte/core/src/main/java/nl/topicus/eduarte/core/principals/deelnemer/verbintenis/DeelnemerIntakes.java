...
@Display(parent = "Deelnemer", label = "Intakes", module = {
	EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS, EduArteModuleKey.BASISFUNCTIONALITEIT})
@Description("Intakes van een deelnemer bekijken")
public class DeelnemerIntakes extends AbstractEduArtePrincipalSource
{

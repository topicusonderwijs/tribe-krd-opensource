...
@Display(parent = "Onderwijs", label = "Taxonomie deelgebieden zoeken", module = EduArteModuleKey.BASISFUNCTIONALITEIT)
@Description("Taxonomie deelgebieden zoeken")
public class TaxonomieElementDeelgebiedenZoeken extends AbstractEduArtePrincipalSource
{

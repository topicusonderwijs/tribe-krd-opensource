...
@Display(parent = "Groep", label = "Pasfoto's", module = EduArteModuleKey.BASISFUNCTIONALITEIT)
@Description("Pasfoto's van deelnemers van groepen bekijken")
public class GroepPasfotos extends AbstractEduArtePrincipalSource
{

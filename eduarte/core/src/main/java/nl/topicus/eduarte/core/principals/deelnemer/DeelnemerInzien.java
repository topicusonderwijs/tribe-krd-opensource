...
@Display(parent = "Deelnemer", label = "Inzien", module = EduArteModuleKey.BASISFUNCTIONALITEIT)
@Description("Basisgegevens van een deelnemer bekijken")
public class DeelnemerInzien extends AbstractEduArtePrincipalSource
{

...
import nl.topicus.eduarte.web.pages.deelnemer.LvsCsvExportPage;

public class LvsCsvExportMenuExtender extends AbstractMenuExtender<DeelnemerCollectiefMenu>
{
	@Override
	public List<IMenuItem> getMenuExtension(DeelnemerCollectiefMenu menu)
	{
		...
		submenu.add(new MenuItem(LvsCsvExportPage.class,
			DeelnemerCollectiefMenuItem.LvsCsvRapportage));
		return ret;
	}
}

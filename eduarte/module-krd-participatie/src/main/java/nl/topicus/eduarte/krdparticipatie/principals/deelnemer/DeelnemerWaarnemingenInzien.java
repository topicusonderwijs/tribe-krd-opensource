...
@Display(parent = "Deelnemer", label = "Waarnemingen", module = {EduArteModuleKey.PARTICIPATIE,
	EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS})
@Description("Inzien van de waarnemingen van een deelnemer")
@Module(EduArteModuleKey.KRD_PARTICIPATIE)
public class DeelnemerWaarnemingenInzien extends AbstractEduArtePrincipalSource
{

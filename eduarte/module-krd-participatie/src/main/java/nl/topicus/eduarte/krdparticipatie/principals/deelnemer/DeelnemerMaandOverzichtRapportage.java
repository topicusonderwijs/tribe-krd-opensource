...
@Display(parent = "Deelnemer", label = "Waarnemingen maandoverzicht", module = {
	EduArteModuleKey.PARTICIPATIE, EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS})
@Description("Raportage waarnemingen maandoverzicht")
@Module(EduArteModuleKey.KRD_PARTICIPATIE)
public class DeelnemerMaandOverzichtRapportage extends AbstractEduArtePrincipalSource
{

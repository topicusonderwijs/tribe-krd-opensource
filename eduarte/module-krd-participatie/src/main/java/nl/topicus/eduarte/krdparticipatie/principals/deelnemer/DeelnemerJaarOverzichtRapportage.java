...
@Display(parent = "Deelnemer", label = "Waarnemingen jaaroverzicht", module = {
	EduArteModuleKey.PARTICIPATIE, EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS})
@Description("Raportage waarnemingen jaaroverzicht")
@Module(EduArteModuleKey.KRD_PARTICIPATIE)
public class DeelnemerJaarOverzichtRapportage extends AbstractEduArtePrincipalSource
{

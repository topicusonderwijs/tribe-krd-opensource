...
@Display(parent = "Deelnemer", label = "Absentiemeldingen", module = {
	EduArteModuleKey.PARTICIPATIE, EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS})
@Description("Inzien van de absentiemeldingen van een deelnemer")
@Module(EduArteModuleKey.KRD_PARTICIPATIE)
public class DeelnemerAbsentiemeldingenInzien extends AbstractEduArtePrincipalSource
{

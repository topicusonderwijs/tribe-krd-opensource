...
public class CollectiviteitVerzuimloketZoekfilterPanel extends
		TypedPanel<DeelnemerVerzuimloketZoekfilter>
{

	private static final long serialVersionUID = 1L;

	public CollectiviteitVerzuimloketZoekfilterPanel(String id,
			DeelnemerVerzuimloketZoekfilter filter)
	{
		...
		form.add(new TextField<BigInteger>("meldingsnummer"));
		form.add(new TextField<Integer>("leerlingnummer"));

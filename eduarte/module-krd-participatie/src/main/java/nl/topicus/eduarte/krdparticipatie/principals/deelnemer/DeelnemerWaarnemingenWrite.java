...
@Write(read = DeelnemerWaarnemingenInzien.class)
@Description("Waarnemingen bewerken")
@Module(EduArteModuleKey.PARTICIPATIE)
public class DeelnemerWaarnemingenWrite extends AbstractEduArtePrincipalSource
{

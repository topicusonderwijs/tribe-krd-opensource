...
@Display(parent = "Beheer", label = "Schooladvies", module = EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS)
@Description("Beheer van schooladvies")
@Write
@Module(EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS)
public class SchooladviesPrincipal extends AbstractEduArtePrincipalSource
{

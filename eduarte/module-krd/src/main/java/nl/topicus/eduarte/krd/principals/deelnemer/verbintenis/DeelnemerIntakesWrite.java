...
@Description("Intakes van een deelnemer bewerken")
@Write(read = DeelnemerIntakes.class)
@Module(EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS)
public class DeelnemerIntakesWrite extends AbstractEduArtePrincipalSource
{

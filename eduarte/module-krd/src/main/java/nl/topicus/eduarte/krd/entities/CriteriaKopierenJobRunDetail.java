...
@DiscriminatorValue("CriteriaKopierenJobRunDetail")
public class CriteriaKopierenJobRunDetail extends JobRunDetail
{
	...
	public CriteriaKopierenJobRunDetail()
	{
	}

	public CriteriaKopierenJobRunDetail(JobRun run)
	{
		super(run);
	}

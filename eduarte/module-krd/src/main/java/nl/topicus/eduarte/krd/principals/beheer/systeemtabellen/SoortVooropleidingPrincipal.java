...
@Display(parent = "Beheer", label = "Soort vooropleiding", module = EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS)
@Description("Beheer van soort vooropleiding")
@Write
@Module(EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS)
public class SoortVooropleidingPrincipal extends AbstractEduArtePrincipalSource
{

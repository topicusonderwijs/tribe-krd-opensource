 ...
 * @author vandekamp
 */
@PageInfo(title = "Collectief productregels invullen (stap 1 van 2)", menu = "Groep > [groep] > Bewerken > Deelnemer toevoegen")
@InPrincipal(DeelnemersOnderwijsproductenCollectieveAfname.class)
public class OndPrCollectieveAfnameStap1Page extends AbstractDeelnemerSelectiePage<Verbintenis>
		implements IEditPage
{
	...
	public OndPrCollectieveAfnameStap1Page()
	{
		this(getDefaultFilter());
	}

	private OndPrCollectieveAfnameStap1Page(VerbintenisZoekFilter filter)
	{
		super(DeelnemerZoekenPage.class, new DeelnemerCollectiefPageContext(
			"Collectief productregels invullen",
			DeelnemerCollectiefMenuItem.OnderwijsproductenToekennen), filter,
			new HibernateSelection<Verbintenis>(Verbintenis.class),
			new OndPrCollectieveAfnameStap1Target());
	}

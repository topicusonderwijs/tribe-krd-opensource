...
@Display(parent = "Beheer", label = "Soort contactgegeven", module = EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS)
@Description("Beheer van soort contactgegevens")
@Write
@Module(EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS)
public class SoortContactgevenPrincipal extends AbstractEduArtePrincipalSource
{

...
@Description("Kenmerken van een deelnemer bewerken")
@Write(read = DeelnemerKenmerken.class)
@Module(EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS)
public class DeelnemerKenmerkenWrite extends AbstractEduArtePrincipalSource
{

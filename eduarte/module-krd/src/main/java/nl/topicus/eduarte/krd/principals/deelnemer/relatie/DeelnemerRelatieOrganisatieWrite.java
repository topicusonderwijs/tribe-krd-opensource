...
@Description("Relaties met organisaties van een deelnemer bewerken")
@Implies(DeelnemerRelaties.class)
@Module(EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS)
@Display(parent = "Deelnemer", label = "Externe organisatie relaties", module = EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS)
@Write
public class DeelnemerRelatieOrganisatieWrite extends AbstractEduArtePrincipalSource
{

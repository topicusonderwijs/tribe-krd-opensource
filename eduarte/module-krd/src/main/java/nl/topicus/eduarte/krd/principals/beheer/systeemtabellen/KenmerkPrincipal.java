...
@Display(parent = "Beheer", label = "Kenmerken", module = EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS)
@Description("Beheer van kenmerken")
@Write
@Module(EduArteModuleKey.KERNREGISTRATIE_DEELNEMERS)
public class KenmerkPrincipal extends AbstractEduArtePrincipalSource
{

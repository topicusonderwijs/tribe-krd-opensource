...
@Description("Resultatenmatrix van een deelnemer bewerken")
@Implies(DeelnemerInzien.class)
@Write(read = DeelnemerResultatenmatrix.class)
@Module(EduArteModuleKey.SUMMATIEVE_RESULTATEN)
public class DeelnemerResultatenmatrixWrite extends AbstractEduArtePrincipalSource
{

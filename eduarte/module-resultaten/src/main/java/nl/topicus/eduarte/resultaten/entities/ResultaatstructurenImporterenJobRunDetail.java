...
@DiscriminatorValue("ResstructsImportJobRunDetail")
public class ResultaatstructurenImporterenJobRunDetail extends JobRunDetail
{
	...
	public ResultaatstructurenImporterenJobRunDetail()
	{
	}

	public ResultaatstructurenImporterenJobRunDetail(JobRun run)
	{
		super(run);
	}

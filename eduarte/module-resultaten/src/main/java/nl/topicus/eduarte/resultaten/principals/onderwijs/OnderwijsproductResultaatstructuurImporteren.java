...
@Description("Resultaatstructuur van een onderwijsproduct importeren")
@Module(EduArteModuleKey.SUMMATIEVE_RESULTATEN)
@Display(parent = "Onderwijs", label = "Resultaatstructuur importeren", module = EduArteModuleKey.SUMMATIEVE_RESULTATEN)
@Write
...
@ExtraPermissions( {@ExtraPermission(type = DataPermission.class, name = Resultaatstructuur.RES_SUMMATIEF
	+ Resultaatstructuur.IMPORTEREN, actions = Enable.class)})
public class OnderwijsproductResultaatstructuurImporteren extends AbstractEduArtePrincipalSource
{

...
@Description("Bijlagen van een onderwijsproduct bewerken")
@Module(EduArteModuleKey.ONDERWIJSCATALOGUS)
@Write(read = OnderwijsproductBijlagen.class)
public class OnderwijsproductBijlagenWrite extends AbstractEduArtePrincipalSource
{

...
@Display(parent = "Beheer", label = "Toetstypen", module = EduArteModuleKey.ONDERWIJSCATALOGUS)
@Description("Toetstypen beheren")
@Write
@Module(EduArteModuleKey.ONDERWIJSCATALOGUS)
public class TypeToetsen extends AbstractEduArtePrincipalSource
{

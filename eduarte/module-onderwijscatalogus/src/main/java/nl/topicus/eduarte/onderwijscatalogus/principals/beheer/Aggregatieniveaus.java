...
@Display(parent = "Beheer", label = "Aggregatieniveau's", module = EduArteModuleKey.ONDERWIJSCATALOGUS)
@Description("Aggregatieniveau's beheren")
@Write
@Module(EduArteModuleKey.ONDERWIJSCATALOGUS)
public class Aggregatieniveaus extends AbstractEduArtePrincipalSource
{

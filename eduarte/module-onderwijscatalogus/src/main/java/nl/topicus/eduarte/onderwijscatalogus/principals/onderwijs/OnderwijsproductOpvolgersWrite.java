...
@Description("Opvolgers van een onderwijsproduct bewerken")
@Module(EduArteModuleKey.ONDERWIJSCATALOGUS)
@Write(read = OnderwijsproductOpvolgers.class)
public class OnderwijsproductOpvolgersWrite extends AbstractEduArtePrincipalSource
{

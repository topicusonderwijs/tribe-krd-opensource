...
@Display(parent = "Beheer", label = "Leerstijlen", module = EduArteModuleKey.ONDERWIJSCATALOGUS)
@Description("Leerstijlen beheren")
@Write
@Module(EduArteModuleKey.ONDERWIJSCATALOGUS)
public class Leerstijlen extends AbstractEduArtePrincipalSource
{

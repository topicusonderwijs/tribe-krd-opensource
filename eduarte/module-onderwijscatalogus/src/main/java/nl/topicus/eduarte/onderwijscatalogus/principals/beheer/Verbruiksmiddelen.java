...
@Display(parent = "Beheer", label = "Verbruiksmiddelen", module = EduArteModuleKey.ONDERWIJSCATALOGUS)
@Description("Verbruiksmiddelen beheren")
@Write
@Module(EduArteModuleKey.ONDERWIJSCATALOGUS)
public class Verbruiksmiddelen extends AbstractEduArtePrincipalSource
{

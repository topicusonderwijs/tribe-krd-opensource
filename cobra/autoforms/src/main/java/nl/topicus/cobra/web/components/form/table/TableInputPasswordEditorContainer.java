 ...
 * @author papegaaij
 */
public class TableInputPasswordEditorContainer<X, Y, Z> extends
		AbstractTableFieldContainer<X, Y, Z>
{
	private static final long serialVersionUID = 1L;

	/**
	 * Maakt een nieuw TableInputPasswordEditorContainer.
	 * 
	 * @param id
	 *            Het id.
	 * @param properties
	 *            De properties.
	 */
	public TableInputPasswordEditorContainer(String id, FieldProperties<X, Y, Z> properties)
	{
		super(id, properties);
	}

;(function($) {
    ...
    */
    ...
    $.widget("ui.dropdownchecklist", {
        ...
        _appendDropContainer: function(required) {
            var wrapper = $("<div/>");
            ...
            if(required){
            container.addClass("ui-dropdownchecklist-dropcontainer required")
                .css("overflow-y", "auto");
            }else{
        ...
        _appendControl: function(required) {
            ...
            var control = $("<span/>");
            if(required){
            	control.addClass("ui-dropdownchecklist required");
            }else{
        ...
        _updateControlText: function() {
            ...
            var text = self._formatText(selectOptions, options.firstItemChecksAll, allSelected, options.summarized);
            var controlLabel = controlWrapper.find(".ui-dropdownchecklist-text");
            controlLabel.text(text);
            controlLabel.attr("title", text);
        },
        // Formats the text that is shown in the control
        _formatText: function(selectOptions, firstItemChecksAll, allSelected, summarized) {
            var text;
        ...
        _init: function() {
            ...
            var dropWrapper = self._appendDropContainer(options.required);
            ...
            var controlWrapper = self._appendControl(options.required);

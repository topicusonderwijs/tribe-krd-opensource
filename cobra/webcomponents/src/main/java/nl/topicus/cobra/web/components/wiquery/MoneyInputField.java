...
public class MoneyInputField extends TextField<BigDecimal> implements IWiQueryPlugin
{
	...
	public MoneyInputField(String id)
	{
		this(id, null);
	}

	public MoneyInputField(String id, IModel<BigDecimal> model)
	{
		this(id, model, 2);
	}

	public MoneyInputField(String id, IModel<BigDecimal> model, int fractionDigits)
	{
		super(id, model);
	...
	{
		return new BigDecimalConverter(fractionDigits);
	}

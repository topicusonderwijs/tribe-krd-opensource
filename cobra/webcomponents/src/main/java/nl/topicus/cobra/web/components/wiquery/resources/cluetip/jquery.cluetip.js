      ...
      if (opts.sticky) {
        ...
        if (opts.mouseOutClose) {
    	  ...
    	  if (opts.mouseOutClose) {
              if ($.fn.hoverIntent && opts.hoverIntent) { 
                $cluetip.hoverIntent({
                  over: function() {cluetipClose(); }, 
                  timeout: opts.hoverIntent.timeout,  
                  out: function() { cluetipClose(); }
                });
              } else {
                $cluetip.hover(function() {cluetipClose(); }, 
 ...
 */
  ...
  $.fn.cluetip.defaults = {  // set up default options
    ...
    attribute:        'abbr',    // the attribute to be used for fetching the clueTip's body content

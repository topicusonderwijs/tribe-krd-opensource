 ...
 * </p>
 * <ul>
 * <li>v2.1 - Cleaned up javadoc comments and unused variables and methods. Added some
 * convenience methods for reading and writing to and from files.</li>
 * <li>v2.0.2 - Now specifies UTF-8 encoding in places where the code fails on systems
 * with other encodings (like EBCDIC).</li>
 * <li>v2.0.1 - Fixed an error when decoding a single byte, that is, when the encoded data
 * was a single byte.</li>
 * <li>v2.0 - I got rid of methods that used booleans to set options. Now everything is
 * more consolidated and cleaner. The code now detects when data that's being decoded is
 * gzip-compressed and will decompress it automatically. Generally things are cleaner.
 * You'll probably have to change some method calls that you were making to support the
 * new options format (<tt>int</tt>s that you "OR" together).</li>
 * <li>v1.5.1 - Fixed bug when decompressing and decoding to a byte[] using
 * <tt>decode( String s, boolean gzipCompressed )</tt>. Added the ability to "suspend"
 * encoding in the Output Stream so you can turn on and off the encoding if you need to
 * embed base64 data in an otherwise "normal" stream (like an XML file).</li>
 * <li>v1.5 - Output stream pases on flush() command but doesn't do anything itself. This
 * helps when using GZIP streams. Added the ability to GZip-compress objects before
 * encoding them.</li>
 * <li>v1.4 - Added helper methods to read/write files.</li>
 * <li>v1.3.6 - Fixed OutputStream.flush() so that 'position' is reset.</li>
 * <li>v1.3.5 - Added flag to turn on and off line breaks. Fixed bug in input stream where
 * last buffer being read, if not completely full, was not returned.</li>
 * <li>v1.3.4 - Fixed when "improperly padded stream" error was thrown at the wrong time.</li>
 * <li>v1.3.3 - Fixed I/O streams which were totally messed up.</li>
 * </ul>
 * <p>
 * I am placing this code in the Public Domain. Do with it as you will. This software
 * comes with no guarantees or warranties but with plenty of well-wishing instead! Please
 * visit <a href="http://iharder.net/base64">http://iharder.net/base64</a> periodically to
 * check for updates or to contribute improvements.
 * </p>
 * 
...
public class Base64
{
	public static final Logger log = LoggerFactory.getLogger(Base64.class);
	...
	/**
	 * Encodes up to the first three bytes of array <var>threeBytes</var> and returns a
	 * four-byte array in Base64 notation. The actual number of significant bytes in your
	 * array is given by <var>numSigBytes</var>. The array <var>threeBytes</var> needs
	 * only be as big as <var>numSigBytes</var>. Code can reuse a byte array by passing a
	 ...
	 * object. If the object cannot be serialized or there is another error, the method
	 * will return <tt>null</tt>. The object is not GZip-compressed before being encoded.
	 * 
	 ...
	 * Does not support automatically gunzipping or any other "fancy" features.
	 * 
	 * @param source
	...
	public static byte[] decodeFromFile(String filename)
	{
		...
		try
		{
			...
			{
				log.error("File is too big for this convenience method (" + file.length()
					+ " bytes).");
				return null;
			...
			// Open a stream
			bis =
				new Base64.InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(
					file)), Base64.DECODE);
	 ...
	 * <tt>java.io.InputStream</tt>, given in the constructor, and encode/decode to/from
	...
	public static class InputStream extends java.io.FilterInputStream
	{
		 ...
		 * <var>len</var> bytes are read. Returns number of bytes read into array or -1 if
	 ...
	 * <tt>java.io.OutputStream</tt>, given in the constructor, and encode/decode to/from
	 * Base64 notation on the fly.
	 * 
	 * @see Base64
	 * @since 1.3
	...
	public static class OutputStream extends java.io.FilterOutputStream
	{
		...
		/**
		 * Method added by PHIL. [Thanks, PHIL. -Rob] This pads the buffer without closing
		 * the stream.
		 */
